...
class MCPVinBusServer:
    ...
    def call_tool(self, tool_name: str, arguments: Dict[str, Any]) -> Dict[str, Any]:
        ...
        return {"jsonrpc": "2.0", "server": self.server_name, "tool": tool_name, "result": json.loads(content)}
...
if __name__ == "__main__":
    ...
    test_result = server.call_tool("route_lookup", {"route_number": "E01"})
    print("✅ Test dispatch tool 'route_lookup' thành công:")
